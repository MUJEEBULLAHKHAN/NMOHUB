...
@Component({
  selector: 'app-home1',
  standalone: true,
  imports: [RouterModule, FormsModule, ReactiveFormsModule, NgbModule, CommonModule,TranslateModule],
  providers: [DisplaymessageComponent],
  templateUrl: './home-customer.component.html',
  styleUrl: './home-customer.component.scss'
})
export class HomeCustomerComponent1 implements OnInit, OnDestroy {
