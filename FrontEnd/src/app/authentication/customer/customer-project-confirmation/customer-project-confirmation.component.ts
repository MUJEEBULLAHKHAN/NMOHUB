...
@Component({
  selector: 'app-customer-project-confirmation',
  standalone: true,
  imports: [RouterModule, FormsModule, ReactiveFormsModule, NgbModule, CommonModule],
  providers: [DisplaymessageComponent],
  templateUrl: './customer-project-confirmation.component.html',
  styleUrl: './customer-project-confirmation.component.scss'
})
export class CustomerProjectConfirmationComponent implements OnInit, OnDestroy {
...
applicationNo: any;
  ...
  ngOnInit(): void {
        ...
        this.projectId = this.route.snapshot.queryParamMap.get('caseid');
