export let SessionsOverviewChartData: any = { 
    series: [{
        name: 'Clicks',
        type: "area",
...
export let EarningReportChartData: any = { 
    series: [{
        name: 'This Week',
...
export let DeviceChartData: any = {  
...
export let BrowserChartData: any = {   
    chart: {
        height: 200,
        type: 'radar',
        toolbar: {
...
export let NewSubscribersChartData: any = {  
    chart: {
        type: 'line',
        height: 50,
        sparkline: {
