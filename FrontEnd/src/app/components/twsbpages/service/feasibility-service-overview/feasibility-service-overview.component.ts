...
@Component({
  selector: 'app-feasibility-service-overview',
  standalone: false,
  //imports: [],
  providers: [DisplaymessageComponent],
  templateUrl: './feasibility-service-overview.component.html',
  styleUrl: './feasibility-service-overview.component.scss'
})
export class FeasibilityServiceOverviewComponent implements OnInit {
  ...
  Approve() {
    ...
    this.approveshowLoader = true;
    this.feasService.ApproveFeasibilityRequest(this.approveProjectRequestModel).subscribe({
      next: (user) => {
        if (user.body.success) {
  ...
  Reject() {
    ...
    this.feasService.RejectFeasibilityRequest(this.rejectProjectRequestModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetFeasibilityRequestDetails();
  ...
  ScheduleMeeting() {
    ...
    this.showLoader = true;
    this.feasService.ScheduleMeeting(this.scheduleMeetingModel).subscribe({
      next: (user) => {
        if (user.body.success) {
  ...
  PitchComplete() {
    ...
    this.showLoader = true;
    this.feasService.PitchComplete(this.pitchCompleteRequestModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetFeasibilityRequestDetails();
  ...
  ReviewPitch() {
    ...
    this.showLoader = true;
    this.feasService.ReviewPitchAndScore(this.reviewPitchAndScoreModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetFeasibilityRequestDetails();
  ...
  SendProposal() {
    ...
    this.showLoader = true;
    this.feasService.SendProposal(this.sendProposalModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetFeasibilityRequestDetails();
  ...
  RejectIdea() {
    ...
    this.showLoader = true;
    this.feasService.RejectIdea(this.rejectIdeaModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetFeasibilityRequestDetails();
  ...
  AcceptProposal() {
    ...
    this.showLoader = true;
    this.feasService.AcceptProposal(this.acceptProposalModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.GetFeasibilityRequestDetails();
        }
  ...
  RejectProposal() {
    ...
    this.showLoader = true;
    this.feasService.RejectProposal(this.rejectProposalModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetFeasibilityRequestDetails();
  ...
  PaymentReceived() {
    ...
    this.showLoader = true;
    this.feasService.PaymentReceived(this.paymentReceivedModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.GetFeasibilityRequestDetails();
        }
  ...
  UploadPaymentProof() {
    ...
    this.showLoader = true;
    this.feasService.UploadPaymentProofdoc(this.uploadPaymentProofdocModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetFeasibilityRequestDetails();
  ...
  ProgramActive() {
    ...
    this.approveshowLoader = true;
    this.feasService.ProgramActiveRequest(this.programActiveRequestModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetFeasibilityRequestDetails();
  ...
  GetProjectStatus() {
    this.feasService.GetProjectStatus().subscribe({
      next: (data) => {
