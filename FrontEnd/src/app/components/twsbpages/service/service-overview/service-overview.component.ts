...
@Component({
  ...
  styleUrl: './service-overview.component.scss'
})
export class ServiceOverviewComponent implements OnInit, AfterViewInit {
  ...
  Approve() {
    ...
    this.jobService.ApproveProjectRequest(this.approveProjectRequestModel).subscribe({
      next: (user) => {
    ...
    //   }
    //   else {
    //     this.toaster.displayErrorMessage('NMO', x.body.message);
    //     this.approveshowLoader = false;
    //   }

    // }, (error) => {
    //   this.toaster.displayErrorMessage('NMO', error.message);
    //   this.approveshowLoader = false;
    // });
  }
  ...
  Reject() {
    ...
    this.jobService.RejectProjectRequest(this.rejectProjectRequestModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetProjectRequestDetailsbyProjectRequestid();
  ...
  ScheduleMeeting() {
    ...
    this.showLoader = true;
    this.jobService.ScheduleMeeting(this.scheduleMeetingModel).subscribe({
      next: (user) => {
        if (user.body.success) {
  ...
  PitchComplete() {
    ...
    this.showLoader = true;
    this.jobService.PitchComplete(this.pitchCompleteRequestModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetProjectRequestDetailsbyProjectRequestid();
  ...
  ReviewPitch() {
    ...
    this.showLoader = true;
    this.jobService.ReviewPitchAndScore(this.reviewPitchAndScoreModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetProjectRequestDetailsbyProjectRequestid();
  ...
  SendProposal() {
    ...
    this.showLoader = true;
    this.jobService.SendProposal(this.sendProposalModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetProjectRequestDetailsbyProjectRequestid();
  ...
  RejectIdea() {
    ...
    this.showLoader = true;
    this.jobService.RejectIdea(this.rejectIdeaModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetProjectRequestDetailsbyProjectRequestid();
  ...
  AcceptProposal() {
    ...
    this.showLoader = true;
    this.jobService.AcceptProposal(this.acceptProposalModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.GetProjectRequestDetailsbyProjectRequestid();
        }
  ...
  RejectProposal() {
    ...
    this.showLoader = true;
    this.jobService.RejectProposal(this.rejectProposalModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetProjectRequestDetailsbyProjectRequestid();
  ...
  PaymentReceived() {
    ...
    this.showLoader = true;
    this.jobService.PaymentReceived(this.paymentReceivedModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.GetProjectRequestDetailsbyProjectRequestid();
        }
  ...
  UploadPaymentProof() {
    ...
    this.showLoader = true;
    this.jobService.UploadPaymentProofdoc(this.uploadPaymentProofdocModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetProjectRequestDetailsbyProjectRequestid();
  ...
  ProgramActive() {
    ...
    this.approveshowLoader = true;
    this.jobService.ProgramActiveRequest(this.programActiveRequestModel).subscribe({
      next: (user) => {
        if (user.body.success) {
          this.modalService.dismissAll();
          this.GetProjectRequestDetailsbyProjectRequestid();
